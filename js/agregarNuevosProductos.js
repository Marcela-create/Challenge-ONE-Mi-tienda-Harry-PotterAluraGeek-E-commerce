import { productService } from '../js/product-servicio'
...
window.addEventListener('DOMContentLoaded', () => {
  Swal.fire({
    title: 'ATENCIÓN',
    text: 'Las opciones en el campo Categoría: "accesorios,varitas, gorros, bufandas, tazas, buzos". Todo en minúscula, sin acentos ',
    icon: 'warning',
